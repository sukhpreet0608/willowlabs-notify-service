...
public class EmailNotificationConsumer {
    ...
    @Bean
    public Consumer<Notification> emailConsumer() {
        return this::processNotification;
    }

    @Transactional
    public void processNotification(Notification notification) {
        log.info("Received EMAIL notification with id={}", notification.getId());
        ...
        try {
            ...
            log.info("EMAIL notification {} processed and DB updated", notification.getId());

        } catch (Exception ex) {
            log.error("Failed to process EMAIL notification {}", notification.getId(), ex);
